...
export default function Legend() {
  return (
    <div className="bg-black/60 backdrop-blur-xl rounded-xl p-4 w-44 border border-white/10">
      ...
      <div className="mt-2.5 pt-2.5 border-t border-white/5 text-[10px] text-gray-600 space-y-1">
        <div><span className="text-gray-400">Cool</span> = favors buyers</div>
        <div><span className="text-gray-400">Hot</span> = favors sellers</div>
      </div>

      <div className="mt-2.5 pt-2.5 border-t border-white/5 text-[9px] text-gray-700 leading-relaxed">
